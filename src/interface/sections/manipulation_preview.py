...
def render_manipulation_preview_section(df: pd.DataFrame, reverse_columns: List[str], 
    ...
    try:
        ...
        # ダウンロード用のデータフレームを準備
        include_original = download_option == "Include both original and reversed columns"
        download_df = prepare_download_data(df, reversed_df, reverse_columns, include_original)
